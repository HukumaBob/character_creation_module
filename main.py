"""This is main file of the greatest game."""
...
def attack(char_name: str, char_class: str) -> str:
    """First of three functions.

    It accept a characters type and
    returns damage to the enemy.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Second of three functions.

    It accept a characters type and
    returns damage to the protagonist.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Third of three functions.

    It accept a characters type and
    returns special skill.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Chose the name and main skill of main hero."""
